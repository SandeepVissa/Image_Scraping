...
def search_and_download(search_term: str, driver_path: str, target_path='./images', number_images=10):
    ...
    with webdriver.Chrome(service=Service(executable_path=driver_path),options=webdriver.ChromeOptions()) as wd:
...
DRIVER_PATH = r'/Users/sandeep/Documents/IITK/coding/Python/Projects/image_scrapper/ImageScrapper/chromedriver'
search_term = 'sandeep vissa'
